...
export function ReviewPhotos() {
  ...
  const [viewType, setViewType] = useState('grid'); // 'grid', 'list', 'bigger'
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 flex items-start justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Review Photos</h1>
          <p className="mt-2 text-gray-600 text-lg">Browse and manage your photos</p>
        </div>
